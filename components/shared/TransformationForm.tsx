...
const TransformationForm = ({ action, data = null, userId, type, creditBalance, config = null }: TransformationFormProps) => {
    ...
    // function for onSelectField handler
    const onSelectFieldHandler = (value: string, onChangeField: (vlaue: string) => void) => {
    ...
    // function for on change input handler
    ...
    // function for transform handler
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                {/* only render if type is remove or recolor */}
